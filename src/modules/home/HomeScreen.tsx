...
//         </View>
//         {/* Recent Activities */}
//         <SectionHeader icon="time-outline" title="Recent Activities" />
...
//               {
//                 time: "2h ago",
//                 text: "Harvest logged — Orchard A",
//                 icon: "basket-outline",
//               },
//               {
//                 time: "1d ago",
//                 text: "Spray applied — Block 3",
//                 icon: "flask-outline",
//               },
//               {
//                 time: "3d ago",
//                 text: "Worker assigned — Daily crew",
//                 icon: "people-outline",
//               },
//             ].map((act, idx) => (
//               <View key={idx} style={styles.activityRow}>
//                 <View style={{ width: 42 }}>
//                   <IconBadge name={act.icon} bg="#7cc47f" />
//                 </View>

//                 <View style={{ flex: 1, paddingLeft: 12 }}>
//                   <Text style={{ fontWeight: "700" }}>{act.text}</Text>
//                   <Text style={{ color: "#666", marginTop: 4 }}>{act.time}</Text>
//                 </View>
...
//         <SectionHeader icon="bar-chart-outline" title="Farm Overview" />
...
//     borderRadius: 10,
//     borderWidth: 1,
//     borderColor: "rgba(30,122,30,0.12)",
//   },
...
>>>>>>> fec40bf (create ui for home and profile page)
  return (
    <View className="flex-1 bg-white px-5 pt-6">
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Weather Card */}
